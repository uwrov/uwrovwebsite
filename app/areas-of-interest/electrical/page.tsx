...
export const metadata: Metadata = {
  ...
  description: "UWROV's Electrical area of interest designs and supports electronic systems including internal circuitry, sensors, and thrusters using ECAD tools.",
};
